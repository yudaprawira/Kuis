            ...
            <div class="mdl-grid" style="padding:0;overflow-x: auto;">
                ...
                <table class="mdl-data-table mdl-shadow--2dp mdl-cell--12-col-desktop" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="mdl-data-table__cell--non-numeric">{{ ($k+1) }}</small></td>
                            <td class="mdl-data-table__cell--non-numeric">{{ val($r, 'member.nama') }}<br/><small>{{ val($r, 'member.email') }}</small></td>
