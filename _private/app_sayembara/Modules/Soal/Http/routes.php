...
//BACKEND
Route::group(['middleware' => 'web', 'prefix' => config('app.backend').'/'.$info['alias'], 'namespace' => 'Modules\Soal\Http\Controllers'], function()
{
...
//FRONT END
Route::group(['middleware'=>'cached', 'prefix' => $info['alias'], 'namespace' => 'Modules\Soal\Http\Controllers'], function()
{
