...
//FRONT END
Route::group(['middleware'=>'web', 'prefix' => 'login', 'namespace' => 'Modules\Membership\Http\Controllers'], function()
{
    Route::get('/', 'FeController@login');
    Route::post('/save', 'FeController@loginSave');
});